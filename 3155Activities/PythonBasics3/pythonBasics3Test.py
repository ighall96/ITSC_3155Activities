...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("This is a statement"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("3 is a number"), False)

        self.assertEqual(pythonBasics3.starts_with_non_number("26: My age"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        self.assertEqual(pythonBasics3.multiple_words("  testing  "), False)

        self.assertEqual(pythonBasics3.multiple_words(" how many words do i use? "), True)

        self.assertEqual(pythonBasics3.multiple_words(" eat-it "), False)
